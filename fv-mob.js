(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      '@media(max-width:768px){#reviews .hp-rev-track{display:grid!important;grid-auto-flow:column!important;grid-template-rows:repeat(2,auto)!important;grid-auto-columns:calc((100vw - 56px)/2.5)!important;gap:10px 12px!important;overflow-x:auto!important;overflow-y:hidden!important;scroll-snap-type:x proximity!important;-webkit-overflow-scrolling:touch!important;scrollbar-width:none!important;-webkit-mask-image:linear-gradient(to right,#000 90%,transparent 100%)!important;mask-image:linear-gradient(to right,#000 90%,transparent 100%)!important;}#reviews .hp-rev-track::-webkit-scrollbar{display:none!important;height:0!important;}#reviews .hp-rev-track>div{width:calc((100vw - 56px)/2.5)!important;max-width:calc((100vw - 56px)/2.5)!important;padding:12px!important;border-radius:12px!important;scroll-snap-align:start!important;overflow:hidden!important;}#reviews .hp-rev-track>div svg[width="18"]{display:none!important;}#reviews .hp-rev-track>div>div:first-child{gap:7px!important;flex-wrap:nowrap!important;}#reviews .hp-rev-track [style*="width:40px"]{width:28px!important;height:28px!important;font-size:12px!important;flex-shrink:0!important;}#reviews .hp-rev-track [style*="flex:1;"]{min-width:0!important;flex:1 1 auto!important;}#reviews .hp-rev-track [style*="font-weight:700; font-size:14.5px"]{font-size:12px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;}#reviews .hp-rev-track [style*="gap:6px; margin-top:2px"]{flex-wrap:nowrap!important;gap:4px!important;}#reviews .hp-rev-track [style*="font-size:11px; color:var(--c-muted)"]{white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;max-width:64px!important;display:inline-block!important;font-size:10px!important;}#reviews .hp-rev-track [style*="color:#f59e0b; font-size:12px"]{font-size:10px!important;flex-shrink:0!important;}#reviews .hp-rev-track p{font-size:12px!important;line-height:1.5!important;margin-top:8px!important;display:-webkit-box!important;-webkit-box-orient:vertical!important;-webkit-line-clamp:4!important;overflow:hidden!important;}}',
