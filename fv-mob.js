(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      '@media(min-width:769px) and (max-width:1024px){#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3)){grid-template-columns:repeat(3,1fr)!important;gap:14px!important;}#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3))>div{min-width:0!important;padding:22px 16px!important;}#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3)) [style*="top: 20px; right: 20px"]{position:static!important;display:inline-block!important;margin:0 0 10px!important;}}',
