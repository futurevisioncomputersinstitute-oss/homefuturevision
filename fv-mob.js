(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      '@media(min-width:769px) and (max-width:1024px){[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]{display:flex!important;flex-wrap:wrap!important;justify-content:center!important;}[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]>div{flex:0 0 auto!important;}[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]>div:first-child:nth-last-child(5),[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]>div:first-child:nth-last-child(5)~div{width:30%!important;}[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]>div:first-child:nth-last-child(4),[style*="var(--c-navy)"][style*="minmax(150px, 1fr)"]>div:first-child:nth-last-child(4)~div{width:22%!important;}}',
      '@media(min-width:769px) and (max-width:1024px){[style*="minmax(215px, 1fr)"]{grid-template-columns:repeat(2,1fr)!important;}[style*="minmax(215px, 1fr)"]>div:last-child:nth-child(odd){grid-column:1/-1!important;max-width:calc(50% - 10px)!important;margin:0 auto!important;}}',
      '@media(min-width:769px) and (max-width:1024px){#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3)){grid-template-columns:repeat(2,1fr)!important;gap:16px!important;}#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3))>div{min-width:0!important;}#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3))>div:last-child{grid-column:1/-1!important;max-width:calc(50% - 8px)!important;margin:0 auto!important;}#fees [style*="minmax(260px, 1fr)"]:has(>div:first-child:nth-last-child(3)) [style*="top: 20px; right: 20px"]{position:static!important;display:inline-block!important;margin:0 0 10px!important;}}',
      '@media(min-width:769px) and (max-width:1024px){[style*="minmax(260px, 1fr)"]:has(>a[style*="rgba(255, 255, 255, 0.05)"]){grid-template-columns:repeat(2,1fr)!important;}[style*="minmax(260px, 1fr)"]:has(>a[style*="rgba(255, 255, 255, 0.05)"])>a:last-child{grid-column:1/-1!important;max-width:calc(50% - 10px)!important;margin:0 auto!important;}}',
      '@media(min-width:769px) and (max-width:1024px){[style*="minmax(260px, 1fr)"]:has(>div>iframe){grid-template-columns:repeat(2,1fr)!important;}[style*="minmax(260px, 1fr)"]:has(>div>iframe)>div:last-child:nth-child(odd){grid-column:1/-1!important;max-width:calc(50% - 10px)!important;margin:0 auto!important;}}',
      '@media(max-width:768px){[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"]){flex-wrap:nowrap!important;align-items:flex-start!important;gap:16px!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 300px"]{flex:1 1 auto!important;min-width:0!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 300px"] h2{font-size:19px!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 300px"] p{font-size:13px!important;line-height:1.5!important;margin-top:10px!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 280px"]{flex:0 0 120px!important;min-width:0!important;width:120px!important;}}',
      '@media(min-width:769px) and (max-width:1024px){[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"]){flex-wrap:nowrap!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 300px"]{flex:1 1 auto!important;min-width:0!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 300px"]):has(>div[style*="min-width: 280px"])>div[style*="min-width: 280px"]{flex:0 0 260px!important;min-width:0!important;width:260px!important;}}',
      '@media(max-width:768px){[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 96px"]){justify-content:center!important;}[style*="flex-wrap: wrap"]:has(>div[style*="min-width: 96px"]) + div{justify-content:center!important;}}',
